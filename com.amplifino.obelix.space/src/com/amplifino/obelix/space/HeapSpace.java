...
/**
 * A Byte Space backed by Java Heap memory
 * 
 *
 */
public final class HeapSpace extends PagedSpace {
	 ...
	 */
	public HeapSpace(int pageShift) {
		super(pageShift);
		if (pageShift > 30) {
	...
	protected ByteSpace map(long page, long pageSize) {
		...
		return ByteBufferSpace.of(ByteBuffer.allocate((int) pageSize));
	}
